...
// PutRuleSpec defines the desired state of PutRule.
type PutRuleSpec struct {
...
// PutRuleStatus defines the observed state of PutRule
type PutRuleStatus struct {
...
// PutRule is the Schema for the PutRules API
// +kubebuilder:object:root=true
// +kubebuilder:subresource:status
type PutRule struct {
	metav1.TypeMeta   `json:",inline"`
	metav1.ObjectMeta `json:"metadata,omitempty"`
	Spec              PutRuleSpec   `json:"spec,omitempty"`
	Status            PutRuleStatus `json:"status,omitempty"`
}

// PutRuleList contains a list of PutRule
// +kubebuilder:object:root=true
type PutRuleList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []PutRule `json:"items"`
}

func init() {
	SchemeBuilder.Register(&PutRule{}, &PutRuleList{})
}
